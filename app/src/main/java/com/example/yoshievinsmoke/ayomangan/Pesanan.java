...
public class Pesanan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =inflater.inflate(R.layout.fragment_pesanan2, container, false);
    ...
    public void getData() {
        ...
        final StringRequest request = new StringRequest(Request.Method.POST, Server.get_pesanan_byseller, new Response.Listener<String>() {
...
//                loading_keramik.setVisibility(View.GONE);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("id_seller", sharedpreferences.getString(TAG_ID,null));
                return map;
            }
        };
